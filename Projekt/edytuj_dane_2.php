...
include_once('polaczenie.php');
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST')
		{
			...
			$stmt1 = $pdo -> prepare("UPDATE osoby SET IMIE='".$imie_m."', NAZWISKO='".$nazwisko_m."', TELEFON='".$telefon_m."', EMAIL='".$email_m."',  NEWSLETTER='".$newsl_m."',  LOGIN='".$login_m."', HASLO='".$haslo_m."' where ID=".$ktory." ");
...
setTimeout(function () {
   window.location.href= 'edytuj_dane.php'; // the redirect goes here
