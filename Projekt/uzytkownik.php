  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        $stmt4 = $pdo->query('SELECT * from osoby JOIN adresy on osoby.ID_ADRESY = adresy.ID WHERE osoby.ID ='.$_SESSION['id_uzytkownik'].'');
		 ...
		 if ($_SESSION['poziom_uprawnienia'] == 'Administrator'){
			...
			echo '<div style="border:1px solid grey;float: left">';
			echo '<a href=dodawanie_produkty.php>Dodaj produkt</a><br>';
			echo '<a href=edytuj_produkty.php>Edytuj produkt</a><br>';
			echo '<a href=usuwanie_produkty.php>Usuń produkt</a><br>';
			echo '<a href=zmien_dane_uzytkownika.php>Zmień dane użytkownika</a><br>';
			echo '<a href=zmien_adres_uzytkownika.php>Zmień adres użytkownika</a><br>';
			echo '<a href=dodawanie_obrazy.php>Dodawanie obrazów</a><br>';
			echo '<a href=transakcje_admin.php>Przeglądaj transakcje</a><br>';
			echo '</div>';
...
//			}
        ...
        if ($_SESSION['poziom_uprawnienia'] == 'Klient'){
            ...
            echo '<a href="transakcje.php"> Zobacz swoje transakcje </a><br>';
