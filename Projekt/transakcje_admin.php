    ...
    <div class="container">
      ...
      <div class="row">
		...
		<?php
			...
			$stmt = $pdo->query('SELECT *, transakcje.ID AS "ID_TRANSAKCJI" FROM transakcje JOIN osoby on transakcje.ID_OSOBY=osoby.ID');
			
			
			
			foreach($stmt as $row)
            {
			echo '<table border="2" style="padding: 10 px">';
